...
public class LottoResult {
    ...
    public Map<WinningSheet, Long> getWinningStatistics() {
        Map<WinningSheet, Long> winningStatisticsWithoutFail = new LinkedHashMap<>(this.winningStatistics);
        winningStatisticsWithoutFail.remove(WinningSheet.FAIL);
        return winningStatisticsWithoutFail;
    }
